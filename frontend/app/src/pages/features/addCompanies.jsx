...
const AddCompanies = () => {
  ...
  useEffect(() => {
    const fetchSubscriptions = async () => {
      setLoading(true);
      try {
        const response = await axios.get(`${API_URL}/api/subscriptions/subscriptions`, getAuthHeader());
  ...
  const handleSubscribe = async () => {
    ...
    try {
      await axios.post(`${API_URL}/api/subscriptions/subscribe`, { company }, getAuthHeader());
    } catch (err) {
